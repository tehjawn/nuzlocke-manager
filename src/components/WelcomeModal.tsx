      ...
      footer={
        <div className="flex justify-end">
          <button
            type="button"
            onClick={onDismiss}
            className="pressable rounded-lg border-accent/40 bg-accent px-5 py-2.5 text-sm font-semibold text-[var(--on-accent)]"
          >
            LFG!
          </button>
        </div>
    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-ink/90">
          ...
          play. Death is permanent — have fun out there.
        </p>
      </div>
    </Modal>
  );
