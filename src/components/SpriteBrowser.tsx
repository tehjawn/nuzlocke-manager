      ...
      footer={
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex gap-2">
            <button
              type="button"
              className="pressable rounded-xl bg-surface px-3 py-2 text-xs font-semibold tracking-tight"
              onClick={onClose}
            >
              Cancel
            </button>
  ...
  return (
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              type="button"
              disabled={!draft}
              className="pressable rounded-xl bg-accent px-3 py-2 text-xs font-semibold text-[var(--on-accent)] disabled:opacity-60"
              onClick={() => {
                if (!draft) return;
                onSelect(draft);
                onClose();
    ...
    >
      <div className="mb-3 flex flex-wrap gap-1.5">
        <button
          type="button"
          className={`pressable rounded-xl px-2.5 py-1.5 text-[11px] font-semibold tracking-tight ${
            generation == null
