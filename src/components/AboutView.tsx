...
/** About content shared by the season workspace About tab. */
    ...
    <div className="space-y-4">
      ...
      <Frame title="This project">
        <p className="text-sm leading-relaxed text-muted">
          ...
          squads, badges, memorials, and season archives in one place. Sign in
          with Discord, claim a trainer board, and keep the run visible for the
          whole pack.
        </p>
      ...
      <Frame title="What is a Nuzlocke?">
        <p className="text-sm leading-relaxed text-muted">
          A Nuzlocke is a self-imposed Pokémon challenge built around permanence
          and restraint. The classic rules: you can only catch the first wild
          Pokémon you encounter in each area, and any Pokémon that faints is
          considered dead — boxed forever, never used again.
        </p>
        <p className="mt-3 text-sm leading-relaxed text-muted">
          Leagues usually layer on house rules (dupes clause, level caps,
          nicknames) so every season feels distinct. This app tracks those runs
          so the story of the squad — wins, losses, and graves — stays with the
          group.
        </p>
      </Frame>
      ...
      <Frame title="Trash Pack">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-sm leading-relaxed text-muted">
              Trash Pack is a Philadelphia friends group of weebs, gamers, and
              not-normies. This is our first Nuzlocke season — we cheer each
              other on through the rough patches and celebrate the wins. Some of
              us also hang out on YouTube reacting to seasonal anime.
            </p>
            <a
              href={TRASH_PACK_YT}
              target="_blank"
