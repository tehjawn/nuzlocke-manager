          ...
          {tab === "ops" ? (
            <div className="gm-console__ops-grid">
              ...
              <Panel
                ...
                description="Replay a trainer’s randomizer seed from their save to see what actually spawns on each route — and where a given Pokémon can be found in their run."
              >
                <button
                  type="button"
                  className="gm-console__btn gm-console__btn--primary"
