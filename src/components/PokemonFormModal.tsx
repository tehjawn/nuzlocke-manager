        ...
        footer={
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="pressable rounded-xl bg-accent px-4 py-2 text-xs font-semibold tracking-tight text-[var(--on-accent)] disabled:opacity-60"
              onClick={() => onSave(form)}
            >
            ...
            <button
              type="button"
              className="pressable rounded-xl bg-surface px-4 py-2 font-display text-xs font-semibold tracking-tight"
              onClick={onClose}
            >
              Cancel
            </button>
            {form.id && onDelete ? (
              <button
                type="button"
                disabled={pending}
                className="pressable ml-auto rounded-xl bg-danger px-4 py-2 text-xs font-semibold tracking-tight text-[var(--on-accent)] disabled:opacity-60"
                onClick={() => {
      ...
      >
        <div className="grid gap-4 sm:grid-cols-[auto_1fr]">
          <div className="flex flex-col items-center gap-2">
            <div className="flex h-28 w-28 items-center justify-center rounded-xl border border-frame bg-surface-2">
              {form.species ? (
                <Image
            ...
            <button
              type="button"
              className="pressable rounded-xl bg-accent px-3 py-2 text-xs font-semibold text-[var(--on-accent)]"
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="text-sm sm:col-span-2">
              ...
              {itemResults.length > 0 && itemQuery.trim() ? (
                <ul className="mt-2 max-h-36 overflow-auto rounded-xl border border-frame bg-surface">
            ...
            {form.slot === "GRAVEYARD" ? (
              <label className="text-sm sm:col-span-2">
                ...
                <textarea
                  className="min-h-16 w-full rounded-xl border border-frame bg-surface px-3 py-2"
